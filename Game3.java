...
public class Game3 extends JPanel implements KeyListener,ActionListener
{
	/**
	 *  
	 */
	...
	private String map = "Best of 3";
	
	JFrame f1 = new JFrame();
	
	public Game3(JFrame f1)
	{	
		this.f1 = f1;
		
		addKeyListener(this);		//Adding the keylistener to the const of Game3. Passing'this' because method defined in same class
		setFocusable(true);
